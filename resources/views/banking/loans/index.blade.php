                ...
                <x-table>
                    <x-table.thead>
                        <x-table.tr>
                            ...
                            <x-table.th class="w-1/12" kind="amount" hidden-mobile>
                                {{ trans('loans.paid') }}
                            </x-table.th>
                            ...
                            <x-table.th class="w-1/12">
                                <x-sortablelink column="status" title="{{ trans('general.status') }}" />
                            </x-table.th>
                        </x-table.tr>
                    </x-table.thead>
                    ...
                    <x-table.tbody>
                        @foreach($loans as $item)
                            <x-table.tr href="{{ route('loans.show', $item->id) }}">
                                ...
                                <x-table.td class="w-1/12" kind="amount" hidden-mobile>
