...
trait SiteApi
{
    ...
    {
        // Self-hosted install: no calls to api.akaunting.com. Every caller
        // already treats a falsy response as "nothing available".
        // To restore, put back the Guzzle request this replaced.
        return false;
    }
