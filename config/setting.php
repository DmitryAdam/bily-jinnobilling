...
return [
    ...
    */
    'fallback' => [
        ...
        'quotation' => [
            'number_prefix'             => env('SETTING_FALLBACK_QUOTATION_NUMBER_PREFIX', 'QUO-'),
            'number_digit'              => env('SETTING_FALLBACK_QUOTATION_NUMBER_DIGIT', '5'),
            'number_next'               => env('SETTING_FALLBACK_QUOTATION_NUMBER_NEXT', '1'),
            'item_name'                 => env('SETTING_FALLBACK_QUOTATION_ITEM_NAME', 'settings.invoice.item'),
            'price_name'                => env('SETTING_FALLBACK_QUOTATION_PRICE_NAME', 'settings.invoice.price'),
            'quantity_name'             => env('SETTING_FALLBACK_QUOTATION_QUANTITY_NAME', 'settings.invoice.quantity'),
            'hide_item_name'            => env('SETTING_FALLBACK_QUOTATION_HIDE_ITEM_NAME', false),
            'hide_item_description'     => env('SETTING_FALLBACK_QUOTATION_HIDE_ITEM_DESCRIPTION', false),
            'hide_quantity'             => env('SETTING_FALLBACK_QUOTATION_HIDE_QUANTITY', false),
            'hide_price'                => env('SETTING_FALLBACK_QUOTATION_HIDE_PRICE', false),
            'hide_amount'               => env('SETTING_FALLBACK_QUOTATION_HIDE_AMOUNT', false),
            'validity_days'             => env('SETTING_FALLBACK_QUOTATION_VALIDITY_DAYS', '30'),
            'template'                  => env('SETTING_FALLBACK_QUOTATION_TEMPLATE', 'default'),
            'color'                     => env('SETTING_FALLBACK_QUOTATION_COLOR', 'purple-500'),
            'title'                     => env('SETTING_FALLBACK_QUOTATION_TITLE', 'Quotation'),
        ],
        'default' => [
